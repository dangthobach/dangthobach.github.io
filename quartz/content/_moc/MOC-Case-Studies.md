...
- [[How to avoid crawling duplicate URLs at Google scale|Google: URL Dedup at Crawler Scale]]
...
- [[How Dropbox Built an AI Product Dash with RAG and AI Agents|Dropbox: AI Dash — RAG + Agents]]
...
- [[EP177- The Modern Software Stack|The Modern Software Stack (2024)]]
...
|---|---|---|
| **Atlassian** — Migrate 4M Jira DBs zero-downtime | Strangler Fig, dual-write, schema migration | [[Strangler-Fig\|Strangler Fig]] |
| **LinkedIn** — 5M QPS restriction, cache invalidation | CQRS read model, event-driven cache | [[CQRS-Materialized-View\|CQRS + Materialized View]] |
| **Slack** — Billions of messages, workspace sharding | Database per Service, Kafka fan-out | [[Database-per-Service\|Database per Service]] |
| **Reddit** — Notification fan-out, celebrity problem | Event-driven (fan-out on write vs read), Pub-Sub | [[01-Data-Consistency\|Data Consistency Patterns]] |
| **Grab** — Auth 180M users, token revocation at scale | Distributed cache invalidation, short-lived JWT | [[02-Communication\|Communication Patterns]] |
| **Tinder** — 1B swipes, gateway-level caching | API Gateway + circuit breaker, request dedup | [[Circuit-Breaker\|Circuit Breaker]], [[02-Communication\|API Gateway]] |
| **Dropbox AI Dash** — RAG pipeline, agent orchestration | Saga (orchestration-based), Event Sourcing cho audit | [[Saga-Pattern\|Saga Pattern]], [[Event-Sourcing\|Event Sourcing]] |
| **Shopify** — Monolith at scale, Cell-based arch | Modular decomposition, DB per domain | [[05-Decomposition\|Decomposition Patterns]] |
| **Google** — URL dedup at crawler scale | Idempotent consumer (bloom filter = idempotency check) | [[02-Communication\|Idempotent Consumer]] |

### Pattern → Observability

Mọi pattern production-grade đều cần instrumentation — xem:
- [[Distributed-Tracing\|Distributed Tracing]] — trace request xuyên services như Grab, Tinder
- [[Metrics-and-Alerting\|Metrics & Alerting]] — monitor circuit breaker state, Saga progress
- [[Log-Aggregation\|Log Aggregation]] — correlate logs từ Slack-style fan-out systems
