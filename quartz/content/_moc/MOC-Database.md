...
- [[A Crash Course on Relational Database Design|Relational Database Design Crash Course]]
  → ER model, normalization 1NF→3NF, keys, constraints. Nền tảng trước khi đi vào advanced topics.
- [[Database Schema Design Simplified- Normalization vs Denormalization|Normalization vs Denormalization]]
...
- [[Key Steps in the Database Selection Process|Database Selection Process]]
...
- [[Database Index Internals- Understanding the Data Structures|Index Internals — Data Structures]]
...
- [[Database Indexing Demystified- Index Types and Use-Cases|Indexing Demystified — Types & Use-Cases]]
...
- [[Database Performance Demystified- Essential Tips and Strategies|Database Performance Demystified]]
...
- [[A Guide to Database Transactions- From ACID to Concurrency Control|Database Transactions: ACID to Concurrency Control]]
...
### Sharding
- [[A Crash Course in Database Scaling Strategies|DB Scaling Strategies Crash Course]]
...
- [[A Guide to Database Sharding- Key Strategies|DB Sharding Guide — Key Strategies]]
...
- [[How to Choose a Replication Strategy|Replication Strategy Decision]]
...
- [[Bai-12-SQLx-Database|Bài 12: SQLx]] — Rust database layer

---

## ⚡ Query Optimization (Deep Dive)

- [[SQL Query Optimization — From Simple to Complex|⭐ SQL Query Optimization — From Simple to Complex]]
...
- [[00-PostgreSQL-Hub]] — Entry point
  - [[01-ACID-Internals]] — Bản chất thật của ACID: WAL, fsync, crash recovery, isolation spectrum
  - [[02-MVCC-Concurrency]] — MVCC engine: xmin/xmax, snapshot, dead tuples, vacuum, HOT update
  - [[03-Concurrency-Patterns]] — Edge cases & bài toán thực tế: lost update, write skew, FOR UPDATE, SKIP LOCKED, advisory locks
  - [[04-Index-Internals]] — B-Tree, GIN, BRIN, partial/covering index
  - [[05-Performance-Tuning]] — Memory, vacuum, monitoring, anti-patterns
  - [[06-Query-Planner]] — Cost model, statistics, join algorithms
